  ...
  return (
    <div className="space-y-8">
      ...
      <div className=" space-y-4 gap-8 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-3 mx-auto">
        ...
        {/* <div className="group md:text-left"> */}
          <img className="mx-auto md:m-0" src={item.icon} alt="icon-logo" />
          {/* <img className="mx-auto md:m-0" src={icon} alt="icon-logo" /> */}
          <p className=" text-[#1c1f35] group-hover:text-[#ffb82b] text-2xl capitalize">{item.txt}</p>
          {/* <p className=" text-[#1c1f35] group-hover:text-[#ffb82b] text-2xl capitalize">{txt}</p> */}
