...
const Banner = ()=>{
    return(
        <div className='bg-red-400 bg-no-repeat bg-cover bg-center relative h-[70vh]' style={{backgroundImage: `url(${home})`}}>
            <div className='w-2/4 absolute top-2/4 -translate-y-2/4 bg-red-500'>
            ...
            <p className=' w-[55%] font-[Rubik] font-semibold text-4xl leading-normal'>Your Gateway to any Destination in the World</p>
