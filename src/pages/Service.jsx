...
const Service = ()=>{
    ...
    const itm = itmAry.map((item,idx)=><div key={idx} className='flex items-start gap-4 bg-red-400'>
        ...
        <div>
            <div>{banner.slice(3, 4).map((item, idx) => <Banner key={idx} {...item} />)}</div>
                ...
                <div style={{background: color.grayBg}}>
                    <div className='w-5/6 mx-auto py-8 bg-red-500'>
                    ...
                    <div className='flex gap-8 h-[50vh]'>
                        ...
                        <div className=' space-y-4 bg-red-200 w-2/4'>
                                {itm}
                        </div>
                    </div>
                    </div>
