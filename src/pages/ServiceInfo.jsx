...
const ServiceInfo = ()=>{
    return(
        <div>
            ...
            <div style={{color: color.grayTxt}} className='mx-auto my-8 w-3/4'>
                ...
                <div>
                    ...
                    <div style={{ backgroundImage: `url(${img3})` }} className="h-[50vh] w-full bg-cover bg-no-repeat bg-bottom relative">
